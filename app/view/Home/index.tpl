                ...
                <ul class="layui-nav" lay-filter="">
                    ...
                    <li class="layui-nav-item">
                        ...
                        <dl class="layui-nav-child">
                            ...
                            <dd><a href="/classLists?type={{ chil.id }}">{{ chil.name }}</a></dd>
                            {% endfor %}
                        </dl>
                        {% endif %}
                    </li>
                            ...
                            <div class="col-md-8 col-md-offset-2">
                                <form action="/search" method="get">
                                    <div class="input-group">
                                        ...
                                        <input class="form-control" type="text" id="example-input3-group2" name="keyword"
                                            placeholder="搜索...">
                                        <span class="input-group-btn">
                    ...
                    <span id="classBox" class="col-lg-3 col-md-3 col-sm-6" onmouseover="show(this)" onmouseout="hide(this)">
                        ...
                        <div id="secondClass" class="block block-themed">
                            <div class="block-header bg-warning">
                                <h3 class="block-title" style="text-align: center"><a href="/classLists?type={{ item.id }}">{{
                                        item.name }}</a></h3>
                            </div>
                            <div class="block-content">
                                {% for chil in item.child %}
                                <div class="classLinks"><a href="/classLists?type={{ chil.id }}">{{ chil.name
                                        }}</a></div>
                                {% endfor %}
                            </div>
                        </div>

        ...
        <div class="js-wizard-simple block">
            ...
            <div class="block-content block-content-mini block-content-full border-b">
                <div class="wizard-progress progress active remove-margin-b">
                    <div class="progress-bar progress-bar-primary progress-bar-striped" role="progressbar" aria-valuenow="100" aria-valuemin="0" aria-valuemax="100" style="width: 33%;"></div>
                </div>
            </div>
            <!-- END Steps Progress -->
            ...
            <form class="form-horizontal" action="/addKnowledge" method="post">
                ...
                <div class="block-content tab-content">
                    ...
                    <div class="tab-pane fade fade-right push-30-t push-50 active in" id="simple-progress-step1">
                        <div class="form-group">
                            ...
                            <div class="col-md-6">
                                <input class="js-maxlength form-control" type="text" id="biaoti" name="title" maxlength="30" placeholder="请输入..." />
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-6">
                                <input class="js-maxlength form-control" type="text" id="zuozhe" value="{{ username }}" maxlength="20" placeholder="请输入..." />
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-6">
                                <select class="js-select2 form-control" id="example-select2" name="classids" data-placeholder="请选择...">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-6">
                                <select class="js-select2 form-control" id="example-select2-multiple" name="tags" data-placeholder="请添加..." multiple>
                                    <option></option><!-- Required for data-placeholder attribute to work with Select2 plugin -->
                                    {% for item in tags %}
                                        <option value="{{ item.id }}">{{ item.name }}</option>
                                    {% endfor %}
                    ...
                    <div class="tab-pane fade fade-right push-30-t push-50" id="simple-progress-step2">
                        <div class="form-group">
                            ...
                            <div class="col-md-6">
                                <select class="js-select2 form-control" id="example-select2" name="power" style="width: 100%;" data-placeholder="请选择...">
                ...
                <div class="block-content block-content-mini block-content-full border-t">
                    <div class="row">
                        <div class="col-xs-6">
                            <button class="wizard-prev btn btn-warning" type="button"><i class="fa fa-arrow-circle-o-left"></i> 上一步</button>
                        </div>
                        <div class="col-xs-6 text-right">
                            <input type="hidden" name="id" value="{{ uid }}" />
                            <button class="wizard-next btn btn-success disabled" type="button" style="display: none;">下一步 <i class="fa fa-arrow-circle-o-right"></i></button>
                            <button class="wizard-finish btn btn-primary" type="submit"><i class="fa fa-check"></i> 上传</button>
                        </div>
                    </div>
                </div>
...
<script>
    jQuery(function () {
        ...
        App.initHelpers(['datepicker', 'datetimepicker', 'colorpicker', 'maxlength', 'select2', 'ckeditor','masked-inputs', 'rangeslider', 'tags-inputs']);
    });
